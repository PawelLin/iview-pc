        ...
        next(null, {
            ...
            data: {
                menuList: [
                    ...
                    { id: 99932, parentId: 9993, title: '自定义组件', icon: 'ios-flower', name: 'demo_component' },
                    { id: 99933, parentId: 9993, title: '自定义过滤器', icon: 'ios-color-filter', name: 'demo_filters' },
                    { id: 99934, parentId: 9993, title: '自定义指令', icon: 'ios-key', name: 'demo_directives' },
                    { id: 99935, parentId: 9993, title: '两种TAG', icon: 'ios-pricetags', name: 'demo_tags' },
